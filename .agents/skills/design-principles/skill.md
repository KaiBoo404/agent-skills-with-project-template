...
Read the full design specs in `.context/agent/design/`:

1. **[style-guide.md](.context/agent/design/style-guide.md)** - Core rules, colors, typography, components
2. **[design-system.md](.context/agent/design/design-system.md)** - Extended tokens, spacing, shadows
3. **[swiss-design-system-prompt.md](.context/agent/design/swiss-design-system-prompt.md)** - AI prompt for Swiss UI
